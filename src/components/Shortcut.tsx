...
const Shortcut :FC = () => {
    return(
        <div className="w-full flex flex-col">
            <p className="p-5 pt-3 pb-3 w-45 bg-emerald-600 shadow-lg shadow-emerald-100 text-white border border-white rounded-lg flex items-start font-semibold md:w-55 md:text-xl">Shortcut Section</p>
